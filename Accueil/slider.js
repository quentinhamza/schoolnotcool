...
function actifIndic(n) {
    affichage(diaporama = n); // j'appelle la foncion affichage en envoyant les arguments "diaporama += n" (diaporama)
} // fin de la foncttion "actifndic"

function affichage(n) { // je déclare une fonction nommée "affichage" qui prend comme argument "n"

    let i; // j'annonce la variable "i"
